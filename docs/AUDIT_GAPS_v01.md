...
9. [Co potřebujeme od vědců](#9-co-potřebujeme-od-vědců)
...
Rozdíl: **~2000-3000 let!**

V tomto období:
- Les se měnil (více lísky, méně břízy)
- Lake Flixton se zmenšoval (zanesení)
- Klima se oteplovalo (přechod boreál → atlantik)
- Star Carr bylo pravděpodobně opuštěné

Design plan v9 to řeší jako "post-occupation — podmínky srovnatelné", ale to je **SPECULATION**, ne INFERENCE.
...
### L10: Temporal gap je slabina
Star Carr 9300-8500 BCE → snapshot 6200 BCE = 2000+ let. Landscape se za tu dobu významně změnil. KB to přiznává ale nepracuje s důsledky.

---

## 9. Co potřebujeme od vědců
...
| **Matematik/Modelář** | Jak nastavit sezónní modifikátory na základě dat? | Statistický model: resource availability per season |
